...
<article id="post-<?php echo get_the_ID(); ?>" <?php post_class(" query-home-post " . esc_attr( $class ) . " col-xs-12 "); ?> data-id='<?php echo get_the_ID(); ?>' data-ajax-url="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>">
