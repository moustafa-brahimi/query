...
<article id="post-<?php echo get_the_ID(); ?>" <?php post_class( "query-home-post query-audio " . esc_attr( $class ) . " col-xs-12" ); ?> data-id='<?php echo get_the_ID(); ?>' data-ajax-url="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>">
  ...
  <div class="title" title="<?php the_title(); ?>">
    ...
    <div class="audio">
      ...
      <?php  echo str_replace('?visual=true', '?visual=false', $media[0]); ?>
