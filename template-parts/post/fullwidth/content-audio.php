...
<article id="post-<?php echo get_the_ID(); ?>" <?php post_class( "query-home-post query-audio " . $class . " col-xs-12" ); ?> data-id='<?php  echo get_the_ID(); ?>' data-ajax-url="<?php admin_url( 'admin-ajax.php' ) ?>">
